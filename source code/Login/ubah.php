	...
	<div class="container">
      <div class="row">
		...
		<form id="registration_form" action="index.php" method="POST" autocomplete="">
			<div>
				<input type="text" id="form_fname" name="name" required="" value="<?php echo $name ?>">
			...
			<div>
				<input type="email" id="form_email" name="email" required="" value="<?php echo $email ?>">
			...
			<div>
				<input type="password" id="form_retype_password" name="cpassword" required="">
